...
```{r, warning=FALSE, message=FALSE}
 word_count %>%
     ...
     wordcloud2(size = 0.6,
                rotateRatio = 0)
```
We can see there are a few words appearing frequently in happy moments: "friend", "family", "time", "home", "dinner", "job", "dog", and so on. Not surprisingly, family, friends and jobs are what we treasure most and hence they are the source of our happiness.
